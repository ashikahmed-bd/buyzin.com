...
<template>
  <main class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="w-full max-w-5xl mx-auto bg-white rounded-lg grid grid-cols-1 md:grid-cols-2">
      ...
      <div class="px-8 py-10">
        ...
        <form @submit.prevent="submit">
          <BaseInput v-model="form.phone" label="Phone Number" placeholder="Enter your phone" :required="true"
            :error="errors?.phone" />
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            <RouterLink to="/auth/forgot" class="text-sm text-primary hover:underline">Forget Password?</RouterLink>
          </div>
        ...
        <p class="text-sm text-center text-body mt-6">
          ...
          <NuxtLink to="/auth/register" class="font-semibold text-primary hover:text-opacity-90">Sign up</NuxtLink>
        </p>
      </div>
    </div>
  </main>
