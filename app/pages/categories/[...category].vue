        ...
        <section class="py-6">
          <div class="flex flex-wrap items-center justify-between gap-4 py-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                type="button"
                class="flex size-9 items-center justify-center rounded border border-primary bg-white text-primary"
              >
              ...
              <button
                type="button"
                class="flex size-9 items-center justify-center rounded border border-gray-200 bg-white text-body"
              >
